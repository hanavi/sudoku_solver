...
# Project:  sudoku.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile sudoku.pro
#############################################################################
...
DISTDIR = /home/james/files/projects/sudoku/.tmp/sudoku1.0.0
LINK          = g++
...
sudoku: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: sudoku.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h sudoku.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp sudoku.cpp $(DISTDIR)/
...
moc_mainwindow.cpp: mainwindow.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/james/files/projects/sudoku/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/james/files/projects/sudoku -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/9.2.0 -I/usr/include/c++/9.2.0/x86_64-pc-linux-gnu -I/usr/include/c++/9.2.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.2.0/include-fixed -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/sudoku/bin || mkdir -p $(INSTALL_ROOT)/opt/sudoku/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/sudoku/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/sudoku/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/sudoku/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/sudoku/bin/ 
